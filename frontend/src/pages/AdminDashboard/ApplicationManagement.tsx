...
const ApplicationManagement: React.FC = () => {
  ...
  // Modal states
  const [selectedPassport, setSelectedPassport] = useState<PassportDetails | null>(null);
  const [selectedVisa, setSelectedVisa] = useState<AdminVisaApplication | null>(null);
