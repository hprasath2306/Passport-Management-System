...
import { getStatusColor, getStatusIcon, isPassportExpired } from "../../utils/index";
        ...
        <div className="expiry-alert">
          <div className="alert-content">
            ...
            <div className="alert-text">
              ...
              <p>
                Your passport expired on {new Date(passportDetails.expiryDate!).toLocaleDateString('en-IN', {
                  day: 'numeric',
                  month: 'long',
                  year: 'numeric'
                })}. 
                You need to renew it to apply for visas or travel internationally.
              </p>
            </div>
            {onRenewal && (
              <button 
      ...
      <div className="passport-card">
        <div className="passport-card-header">
          ...
          <div className="passport-status-badge">
            <span
              className={`status-badge ${getStatusColor(displayStatus)}`}
            >
                ...
                <div className="info-item">
                  <div>
                    ...
                    <span className="info-value">
                      {passportDetails.userFirstName} {passportDetails.userLastName}
                    </span>
                  </div>
                </div>
                <div className="info-item">
                  <div>
                    ...
                    <span className="info-value">{passportDetails.userCitizenType}</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="info-grid">
                <div className="info-item">
                  ...
                  <div>
                    ...
                    <span className="info-value">{passportDetails.userEmail}</span>
                  </div>
                </div>
                <div className="info-item">
                  ...
                  <div>
                    ...
                    <span className="info-value">{passportDetails.userPhone}</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="info-grid">
                <div className="info-item">
                  <div>
                    ...
                    <span className="info-value">
                      {new Date(passportDetails.applicationDate).toLocaleDateString('en-IN', {
                        day: 'numeric',
                        month: 'long',
                        year: 'numeric'
                      })}
                ...
                {passportDetails.issueDate && (
                  <div className="info-item">
                    <div>
                      ...
                      <span className="info-value">
                        {new Date(passportDetails.issueDate).toLocaleDateString('en-IN', {
                          day: 'numeric',
                          month: 'long',
                          year: 'numeric'
                        })}
                ...
                {passportDetails.expiryDate && (
                  <div className="info-item">
                    <div>
                      ...
                      <span className={`info-value ${isExpired ? 'expiry-warning' : ''}`}>
                        {new Date(passportDetails.expiryDate).toLocaleDateString('en-IN', {
                          day: 'numeric',
                          month: 'long',
                          year: 'numeric'
                        })}
                        {isExpired && <span className="expiry-warning"> (Expired)</span>}
                      </span>
                    </div>
                  </div>
                )}
              ...
              <div className="info-grid">
                <div className="info-item">
                  <div>
                    ...
                    <span className="info-value amount">₹{passportDetails.amountPaid}</span>
                  </div>
                </div>
                {passportDetails.processingDays && (
                  <div className="info-item">
                    ...
                    <div>
                      ...
                      <span className="info-value">{passportDetails.processingDays} days</span>
                    </div>
                  </div>
                )}
              </div>
                ...
                <div className="info-grid">
                  <div className="info-item">
                    <div>
                      ...
                      <span className="info-value">{passportDetails.previousPassportId}</span>
                    </div>
                  </div>
                </div>
              </div>
